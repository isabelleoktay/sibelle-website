...
const Navigation = () => {
    return (
        <nav className="font-playfair font-bold py-4 px-6 font-playfair flex flex-col text-center sm:flex-row sm:text-left sm:justify-between sm:items-baseline w-fullr">
            <div className="mb-2 sm:mb-0">
                <a href="/home" className="text-6xl text-slate-300">Si Belle</a>
            </div>
            <div>
